...
const userNumbers = prompt(`Укажіть 10 любих чисел через пробіл
...
const joinedArraySplitedUserNumbers = parseFloat(arraySplitedUserNumbers.join(""));
// const convertedJoinedArraySplitedUserNumbers = parseFloat(arraySplitedUserNumbers); 
